[[https://github.com/nholuongut/all-roadmaps][View all Roadmaps]]  
...
| List all container images            | [[https://github.com/nholuongut/kubernetes-cheatsheet-a4/blob/master/list-all-images.sh#L14-L17][list-all-images.sh]]                                                                        |
| kubeconfig skip tls verification     | [[https://github.com/nholuongut/kubernetes-cheatsheet-a4/blob/master/skip-tls-verify.md][skip-tls-verify.md]]                                                                        |
...
| Reference                            | [[https://cheatsheet.nholuong.com/cheatsheet-minikube-A4][minikube cheatsheet]], [[https://cheatsheet.nholuong.com/cheatsheet-docker-A4][docker cheatsheet]], [[https://cheatsheet.nholuong.com/cheatsheet-openshift-A4][OpenShift CheatSheet]]                              |
** Check Performance
| Name                                         | Command                                              |
|----------------------------------------------+------------------------------------------------------|
...
#+BEGIN_HTML
<a href="https://cheatsheet.nholuong.com"><img align="right" width="185" height="37" src="https://raw.githubusercontent.com/nholuong/cheatsheet.nholuong.com/master/images/cheatsheet_dns.png"></a>
#+END_HTML
** Log & Conf Files
| Name                      | Comment                                                                   |
|---------------------------+---------------------------------------------------------------------------|
...
| Reference                    | [[https://cheatsheet.nholuong.com/kubernetes-yaml-templates][Link: kubernetes yaml templates]]                                                           |
** Label & Annotation
| Name                             | Command                                                           |
|----------------------------------+-------------------------------------------------------------------|
...
| Manually add annotation to a pod | =kubectl annotate pods dummy-input my-url=https://nholuong.com= |
** Deployment & Scale
| Name                         | Command                                                                  |
|------------------------------+--------------------------------------------------------------------------|
...
| Reference     | [[https://cheatsheet.nholuong.com/kubernetes-yaml-templates][Link: kubernetes yaml templates]], [[https://kubernetes.io/docs/concepts/workloads/controllers/deployment/#pausing-and-resuming-a-deployment][Link: Pausing and Resuming a Deployment]] |
#+BEGIN_HTML
<a href="https://cheatsheet.nholuong.com"><img align="right" width="185" height="37" src="https://raw.githubusercontent.com/nholuong/cheatsheet.nholuong.com/master/images/cheatsheet_dns.png"></a>
#+END_HTML
...
| Reference                        | [[https://cheatsheet.nholuong.com/kubernetes-yaml-templates][Link: kubernetes yaml templates]], [[https://kubernetes.io/docs/concepts/configuration/secret/][Link: Secrets]]                          |
** StatefulSet
| Name                               | Command                                                  |
|------------------------------------+----------------------------------------------------------|
