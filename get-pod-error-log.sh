...
## Description : https://cheatsheet.nholuong.com/cheatsheet-kubernetes-A4
## --
## Created : <2018-07-10>
## Updated: Time-stamp: <2019-07-31 22:54:01>
##-------------------------------------------------------------------
# curl -L https://raw.githubusercontent.com/nholuong/cheatsheet-kubernetes-A4/master/get-pod-error-log.sh | bash
namespace=${1:-""}
